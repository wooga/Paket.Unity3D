...
let githubLink = "http://github.com/wooga/Paket.Unity3D"

// Specify more information about your project
let info =
  [ "project-name", "Paket.Unity3D"
    "project-author", "devboy"
    "project-summary", "Piggy-backs ontop of Paket to add dependencies to Unity3D projects"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Paket.Unity3D" ]
// --------------------------------------------------------------------------------------
